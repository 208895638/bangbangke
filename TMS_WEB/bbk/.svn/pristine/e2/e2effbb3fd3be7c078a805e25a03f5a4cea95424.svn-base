$(function(){
	...
	function replaceData(data){
		...
		for(var i=0;i<data.length;i++){
			var _priceSource = (data[i].Quotation_type!="报价不限"&&data[i].Quotation_type)?"一口价:"+data[i].Price:"自由报价";
			
			temp += '<li priceType="'+data[i].Quotation_type+'" goodId="'+data[i].Id+'" class="order-detail d-flex bg-white padding-b-15 flex-column bor-bottom margin-b-10">'
