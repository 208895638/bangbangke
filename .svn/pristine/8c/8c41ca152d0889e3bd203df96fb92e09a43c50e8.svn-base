...
$(function () {
    ...
    MPicker.prototype = {
        ...
        render: function () {
            ...
            mainStr = '<div class="mPicker-main ' + _this.disy + '" data-pickerId="' + _this.pickerId + '">' + _this.options.header +  _this.options.footer + '<div class="mPicker-content">' + listStr + '</div><div class="mPicker-shadow"></div></div>';
